...
- 터미널 키 팝업을 하단 접이식 패널로 바꿨습니다. 기본 한 줄은 48dp이며 도구를 펼쳤을 때만 144dp를 추가 사용합니다. 출력과 화면 키를 함께 조작할 수 있습니다.
- 전체 기능을 작업 공간·앱과 서비스·서버와 시스템으로 나누고 검색 시 빈칸을 제거했습니다. 기존 16개 관리 화면은 유지합니다.
- 서버 목록을 80dp 행으로 줄이고 삭제·인증서 신뢰 해제를 서버별 메뉴로 옮겼습니다. 보기 설정은 상단에 배치했습니다.
