...
Run: `/home/devuser/go/bin/golangci-lint run ./internal/security/...`
Expected: clean.
...
Run: `/home/devuser/go/bin/golangci-lint run ./internal/api/... ./internal/feature/security/... ./internal/security/...`
Expected: clean.
...
```bash
curl -s -H "Authorization: Bearer $TOKEN" "http://192.168.1.x:8444/api/v1/security/policy" | python3 -m json.tool
```
