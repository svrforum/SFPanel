...
Run: `/home/devuser/go/bin/golangci-lint run ./internal/feature/compose/...`
Expected: clean.
...
/home/devuser/go/bin/golangci-lint run ./internal/feature/compose/...
```
...
Run: `/home/devuser/go/bin/golangci-lint run ./internal/docker/...`
Expected: clean.
...
go test ./internal/feature/compose/ -count=1 -v
go build ./...
/home/devuser/go/bin/golangci-lint run ./internal/feature/compose/... ./internal/docker/...
```
...
Run: `/home/devuser/go/bin/golangci-lint run ./internal/docker/... ./internal/feature/compose/...`
Expected: clean.
...
scp ./sfpanel root@192.168.1.x:/tmp/sfpanel.new
ssh root@192.168.1.x 'systemctl stop sfpanel && cp /tmp/sfpanel.new /usr/local/bin/sfpanel && systemctl start sfpanel && sleep 4 && systemctl is-active sfpanel'
```
