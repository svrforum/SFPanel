...
빌드·설치 방법과 검증 범위는 [Android 앱 안내](android/README.md)를 참고하세요. [GitHub 릴리즈](https://github.com/svrforum/SFPanel/releases/tag/android-v0.1.3)에서 서명된 APK를 받을 수 있습니다. `android-v*` 태그를 push하면 테스트와 서명 검증 후 자동 배포됩니다.
